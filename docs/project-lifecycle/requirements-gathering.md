...
description: Decide what problem we're going to solve, and what "solved" means.
---

## Overview

In this phase you will produce the requirements portion of a [Design Document](../standards/design-template.md) and get that approved.
...
When you've filled in the Requirements section of [this design doc template](../standards/design-template.md) and gotten it approved by your key approvers.
